...
const double abort_worse = 1e-1;

const int iterations_fine = 1000;

const double solved_fine = 1e-24;
...
const double better_frac = 1.001; // will accept if still solved or no worse than this times previous
